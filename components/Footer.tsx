    ...
    <footer className="border-t border-line bg-paper mt-8">
      <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="https://www.facebook.com/profile.php?id=61556442362464"
            target="_blank"
          ...
          <a href="https://www.linkedin.com/in/muhammad-asghar-s-47b7902b5/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn"
            className="text-slate hover:text-ink transition-colors"
          ...
          <a href="https://www.saashub.com/rankinseo-xyz?utm_source=badge&utm_campaign=badge&utm_content=rankinseo-xyz&badge_variant=color&badge_kind=approved"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="RankinSEO on SaaSHub"
          >
            <img
              src="https://cdn-b.saashub.com/img/badges/approved-color.png?v=1"
              alt="RankinSEO.xyz badge"
